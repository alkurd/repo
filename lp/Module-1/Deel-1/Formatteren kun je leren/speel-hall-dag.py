...
Gewenste_speel_tijd = int(input("Hoe veel minuten willen jullie gaan spellen? "))
Kosten_per_5_minuten = 37
...
print("-" * 35)
print(f"Entree ({personen} personen):           €{kosten_entree/100:.2f}")
print(f"VR-game ({Gewenste_speel_tijd} minuten): €{totale_kosten_VR_game/100:.2f}")
print("-" * 35)
print(f"Totaal:                               €{totaal_bedrag/100:.2f}")
print("-" * 35)
